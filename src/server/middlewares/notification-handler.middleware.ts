...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Fleet Manager.create': {
    roles: ['owner', 'admin', 'operations-staff', 'customer-service-representative'],
    key: 'fleet_add',
    tenantPath: [],
    userPath: [],
  },
  'Operations Staff.create': {
    roles: ['owner', 'fleet-manager', 'admin', 'customer-service-representative'],
    key: 'route_plan',
    tenantPath: [],
    userPath: [],
  },
  'Customer Service Representative.update': {
    roles: ['owner', 'fleet-manager', 'admin', 'operations-staff'],
